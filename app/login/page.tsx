        ...
        <div className="max-w-[400px] w-full mx-auto my-auto py-4 relative z-10">
          ...
          <div className="space-y-5">
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full pl-4 pr-10 py-3.5 bg-gray-50/80 border border-gray-200 rounded-xl outline-none focus:bg-white focus:border-green-500 transition-all text-sm font-medium" 
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input 
                  ...
                  className="w-full pl-4 pr-12 py-3.5 bg-gray-50/80 border border-gray-200 rounded-xl outline-none focus:bg-white focus:border-green-500 transition-all text-sm font-medium" 
                  placeholder="••••••••" 
                />
            ...
            <button 
              ...
              disabled={isLoading} 
              className="w-full bg-green-600 hover:bg-green-500 text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-lg shadow-green-600/20 mt-6 disabled:opacity-50 flex items-center justify-center gap-2 hover:-translate-y-0.5"
            >
